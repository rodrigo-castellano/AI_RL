            ...
            while not end_episode:
                ...
                for j in list_pos:
                    if Q[s_current,j]>best_Q:
                        ...
                        best_action = j
                action = best_action
                #print('s_current, action',s_current,action )
                # ADD YOUR CODE SNIPPET BETWEEN EX 2.1 and 2.2
                ...
                # print('np.amax(Q[s_next])',np.amax(Q[s_next]))
                # print('Q[s_current,action]',Q[s_current,action])
                Q[s_current,action] = Q[s_current,action] + self.alpha*(R+self.gamma*np.nanmax(Q[s_next])-Q[s_current,action])
                #print('Q[s_current,action] new',Q[s_current,action])
                #print('new Q', Q)
                # ADD YOUR CODE SNIPPET BETWEEN EX. 2.2
