...
class PlayerControllerRL(PlayerController, FishesModelling):
    ...
    def q_learning(self):
        ...
        Q = np.random.uniform(0.0,1.0,size=(ns,na))
        # ADD YOUR CODE SNIPPET BETWEEN EX. 2.1
        ...
        ovr_epsilon = self.epsilon_initial
        ...
        while episode <= self.episode_max and diff>self.threshold:
            ...
            while not end_episode:
                ...
                new_epsilon, action = epsilon_greedy(Q, s_current, list_pos, steps, ovr_epsilon, self.epsilon_final, self.annealing_timesteps, eps_type="linear")
                # ADD YOUR CODE SNIPPET BETWEEN EX 2.1 and 2.2
                ovr_epsilon = new_epsilon
        ...
        while episode <= self.episode_max:
            ...
            while not end_episode:
                ...
                for j in possible_actions:
                    if Q[s_current,j]>best_Q:
                        best_Q = Q[s_current,j]
                        best_action = j
...
class ScheduleLinear(object):
    ...
    def value(self, t):
        ...
        et = self.initial_p + delta_e*(float(t/self.schedule_timesteps))
        return et
        # ADD YOUR CODE SNIPPET BETWEEN EX 3.2
